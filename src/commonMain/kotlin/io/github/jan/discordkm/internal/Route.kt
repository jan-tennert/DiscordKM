...
object Route {
    ...
    object Guild {
        ...
        const val GET_GUILD_APPLICATION_COMMAND_PERMISSIONS = "/applications/%s/guilds/%s/commands/permissions"
        const val GET_APPLICATION_COMMAND_PERMISSIONS = "/applications/%s/guilds/%s/commands/%s/permissions"
