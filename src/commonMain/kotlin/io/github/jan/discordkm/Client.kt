...
import io.github.jan.discordkm.entities.misc.GuildList
import io.github.jan.discordkm.entities.misc.Image
import io.github.jan.discordkm.entities.misc.UserList
...
sealed class Client(val token: String, val loggingLevel: Logger.Level) : CoroutineScope {
    ...
    internal var userCache = io.github.jan.discordkm.Cache<User>()
    internal var guildCache = io.github.jan.discordkm.Cache<Guild>()
